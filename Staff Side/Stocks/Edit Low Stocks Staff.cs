...
{
    public partial class Edit_Low_Stocks_Staff : Form
    {
        private string _itemID;
        private Manage_Stocks_Staff dashboard;
        private Inventory_Dashboard_Staff _inventoryDashboard;
        private Low_Stocks_Staff lowStocks;

        public Edit_Low_Stocks_Staff(string itemID, Inventory_Dashboard_Staff inventoryDashboard, Manage_Stocks_Staff dashboard, Low_Stocks_Staff lowStocks)
        {
            InitializeComponent();
        ...
        private void Edit_Low_Stocks_Staff_Load(object sender, EventArgs e)
        {
